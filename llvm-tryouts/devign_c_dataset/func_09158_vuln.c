static inline void mc_dir_part(H264Context *h, Picture *pic, int n, int square, int chroma_height, int delta, int list,
    ...
    int extra_width= (s->flags&CODEC_FLAG_EMU_EDGE) ? 0 : 16; 
    ...
    if(   full_mx < 0-extra_width
       ...
       || full_my + 16 > pic_height + extra_height){
        ...
        ff_emulated_edge_mc(s->edge_emu_buffer, src_y - 2 - 2*s->linesize, s->linesize, 16+5, 16+5, full_mx-2, full_my-2, pic_width, pic_height);
    ...
    if(emu){
        ...
        ff_emulated_edge_mc(s->edge_emu_buffer, src_cb, s->uvlinesize, 9, 9, (mx>>3), (my>>3), pic_width>>1, pic_height>>1);
    ...
    if(emu){
        ...
        ff_emulated_edge_mc(s->edge_emu_buffer, src_cr, s->uvlinesize, 9, 9, (mx>>3), (my>>3), pic_width>>1, pic_height>>1);
